...
\begin{frame}[label=ct1]{\usebeamercolor[fg]{structure}\color{fg}Wer sind wir?}
...
\begin{frame}[label=ct1b]{\usebeamercolor[fg]{structure}\color{fg} Uni-Stick}
...
\begin{frame}[label=ct2]{\usebeamercolor[fg]{structure}\color{fg}Warum machen wir das? Aus Überzeugung.}
~\\[6mm]
  \begin{itemize}
...
\begin{frame}[label=ct3]{\usebeamercolor[fg]{structure}\color{fg}Zukunftsideen}
\begin{itemize}
...
\begin{frame}[label=ct4]{\usebeamercolor[fg]{structure}\color{fg}{Weitere Informationen}}
